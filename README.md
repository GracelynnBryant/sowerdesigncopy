...
## Environments
- Preview: https://main--sowerdesigncopy--GracelynnBryant.aem.page/
- Live: https://main--sowerdesigncopy--GracelynnBryant.aem.live/
...
1. Open the `sowerdesigncopy` directory in your favorite IDE and start coding :)